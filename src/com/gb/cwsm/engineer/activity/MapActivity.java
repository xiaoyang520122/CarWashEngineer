...
//		mMapView.showZoomControls(false);  //隐藏缩放按钮
	...
	private void displaylocation() {
		...
		GeoPoint myLocationPoint = new GeoPoint((int) ( latitude * 1E6), (int) (longitude * 1E6));
...
//		mMapController.setCenter(myLocationPoint);
	...
	public class MyLocationListener implements BDLocationListener {
		...
		public void onReceiveLocation(BDLocation location) {
			...
			sb.append("\nerror code : ");
			sb.append(location.getLocType());//定位返回错误码
			sb.append("******************"+location.getCity()+location.getCityCode());//定位返回错误码
			sb.append("\nlatitude : ");
